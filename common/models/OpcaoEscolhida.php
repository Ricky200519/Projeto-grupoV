...
class OpcaoEscolhida extends \yii\db\ActiveRecord
{
    ...
    public function rules()
    {
        return [
            ...
            [['tentativa_id'], 'exist', 'skipOnError' => true, 'targetClass' => Tentativa::class, 'targetAttribute' => ['tentativa_id' => 'id']],
            [['resposta_id'], 'exist', 'skipOnError' => true, 'targetClass' => Resposta::class, 'targetAttribute' => ['resposta_id' => 'id']],
