...
<div class="main-card bg-white mt-4 border border-primary border-2">
    <div class="card bg-white mt-2 p-5 mx-auto w-100 border border-primary border-2" style="max-width: 800px; margin: 0 auto;">
        ...
        <div class="mb-4">
            <h5 class="mb-2"><strong>Respostas certas: </strong><?= $pontuacao['acertos'] ?>
                / <?= $pontuacao['totalPerguntas'] ?></h5>
            <div class="progress" style="height: 1.5rem; border-radius: 0.75rem;">
                <div id="progressBar" class="progress-bar bg-primary" role="progressbar"
                     style="width: 0; transition: width 1s;">0%
                </div>
            </div>
        </div>
                        ...
                        <ul class="list-group" id="respostasList">
                            <?php foreach ($tentativa->opcaoescolhidas as $op): ?>
                                ...
                                rounded mb-2 shadow-sm resposta-item"
                                    ...
                                    <div>
                                        <strong>Pergunta:</strong> <?= Html::encode($op->resposta->pergunta->texto) ?>
                                        <br>
        ...
        <div class="accordion mb-4" id="rankingAccordion">
            <div class="accordion-item">
                <h2 class="accordion-header" id="headingRanking">
                    <button class="accordion-button collapsed fas fa-trophy text-warning" type="button"
